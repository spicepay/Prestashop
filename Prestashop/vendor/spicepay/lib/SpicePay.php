...
class SpicePay
{
    ...
    public static function request($url, $method = 'POST', $params = array(), $authentication = array())
    {
        ...
        //     \SpicePay\Exception::throwException(400, array('reason' => 'BadEnvironment', 'message' => "Environment does not exist. Available environments: $availableEnvironments"));
        // }

        $url       = ($environment === 'sandbox' ? 'https://api-sandbox.spicepay.com/v1' : 'https://api.spicepay.com/v1') . $url;
